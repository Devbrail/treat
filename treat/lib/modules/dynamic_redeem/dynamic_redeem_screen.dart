...
class DynamicRedeemScreen extends StatefulWidget {
  const DynamicRedeemScreen({Key? key}) : super(key: key);

  @override
  _DynamicRedeemScreenState createState() => _DynamicRedeemScreenState();
}

class _DynamicRedeemScreenState extends State<DynamicRedeemScreen>
    with SingleTickerProviderStateMixin {
  TabController? _tabController;
  bool tipIs = false;

  TextEditingController _controller = TextEditingController();
  TextEditingController _controllerTip = TextEditingController();
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    _rc.redeemCoupon(_controller.text);
                    Get.back();
                  },
                  child: Container(
                    height: 51,
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _rc.cardDeatails != null
                      ? NormalText(
                          text:
                              '${_rc.cardDeatails[0]['cardType'] ?? ""} ${_rc.cardDeatails[0]['cardNo'] ?? ""}',
                          fontSize: 15,
                          textColor: ColorConstants.black,
                        )
                      : SizedBox(),
              ...
              ? ExpansionTile(
                  ...
                  children: [
                    ListView.separated(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      _rc.cardDeatails != null
                                          ? NormalText(
                                              text:
                                                  '${_rc.cardDeatails[index]['cardType'] ?? ""} ${_rc.cardDeatails[index]['cardNo'] ?? ""}',
                                              fontSize: 15,
                                              textColor: ColorConstants.black,
                                            )
                                          : SizedBox(),
                        ...
                        itemCount: _rc.cardDeatails.length)
                    // for (var i = 0; i < _rc.cardDeatails.length; i++)
  ...
  Future<void> _showTipEnter(BuildContext context) async {
    return showModalBottomSheet(
        context: context,
        isScrollControlled: true,
        builder: (context) {
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                NormalText(
                  text: "A little bit goes a long way! :)",
                  fontSize: 12,
                ),
                SizedBox(height: 16),
                InkWell(
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return Obx(() => InkWell(
                      onTap: () {
                        _rc.selectedTips = index;
                        index == 3 ? _showTipEnter(context) : null;
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          color: _rc.selectedTip == index
                              ? ColorConstants.redemptionTextViolet
                        ...
                        child: Column(
                          ...
                          children: [
                            NormalText(
                              ...
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              textColor: _rc.selectedTip == index
